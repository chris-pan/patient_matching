...
def main(uploaded_file):
    df_in = pd.read_excel("/Users/enya/impatient_matching/media/data.xlsx")
    #change destination to whereever the provided Patient Matching Data is stored
    df = pd.read_excel('/Users/enya/impatient_matching/matching/src_quick_access/data.xlsx',sep=",")
    ...
    #change destination
    df_in.to_csv('/Users/enya/impatient_matching/matching/src_quick_access/predicted_matches.csv', index = False, header = True)
